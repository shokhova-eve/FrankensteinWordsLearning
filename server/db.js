...
// This file is committed to git — it's the shipped word content only.
// Visitor data (users/sessions/progress/mastery/texts) lives in
// app-data.db (see app-db.js) so that pushing new words never overwrites
// anyone's live progress.
